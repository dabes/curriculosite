    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card-body formacao">
          <h5 class="card-title" style="font-size: 1.5rem; font-weight: 300">
            <img class="hidden img-print" src="../assets/img/coding.png" />
            Habilidades
          </h5>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    window.axios
      .get(process.env.VUE_APP_API + "/api/habilidade/" + this.curriculoUid)
      .then((response) => {
